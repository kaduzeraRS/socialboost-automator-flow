            ...
            <Card className="border-green-500 dark:bg-card bg-white border-2 shadow-lg">
              <CardHeader>
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <span className="text-foreground">Seu Plano Atual: {userSubscription.plan.name}</span>
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-green-500">R$ {userSubscription.plan.price.toFixed(2).replace('.', ',')}</div>
