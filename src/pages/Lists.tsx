...
import { Download, Calendar, Users, Clock, Trash2, User } from 'lucide-react';
...
const Lists = () => {
  ...
  const [lists, setLists] = useState([
    ...
    {
      id: '4',
      targetProfile: '@kyliejenner',
      followersCount: 398000000,
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-muted-foreground">
              {isAdmin || isModerator ? 
                'Visualize e gerencie todas as listas de seguidores dos usuários' : 
                'Gerencie suas listas de seguidores capturadas dos perfis alvo'
              }
            </p>
          </div>
                        ...
                        <div className="flex items-center space-x-2">
                          {(isAdmin || isModerator) && (
                            <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                              ...
                              <span className="text-xs">({list.ownerEmail})</span>
                            </div>
                          )}
                          {isExpired ? (
